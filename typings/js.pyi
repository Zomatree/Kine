...
class Headers:
    ...
    def forEach(
        self, callbackfn: Proxy[Callable[[str], None] | Callable[[str, Self], None] | Callable[[str, str, Self], None]]
    ) -> None: ...
...
class URLSearchParams:
    ...
    def sort(self) -> None: ...
    def forEach(
        self, callbackfn: Proxy[Callable[[str], None] | Callable[[str, str], None] | Callable[[str, str, Self], None]]
    ) -> None: ...
