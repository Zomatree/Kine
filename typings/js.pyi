...
@overload
def fetch(url: RequestInfo | URL, **options: Unpack[FetchOptions]) -> Promise[Response]:
    ...
...
class WebSocket(EventTarget):
    ...
    @overload
    def new(self, url: str | URL) -> None:
        ...

    @overload
    def new(self, url: str | URL, protocols: str | Array[str]) -> None:
        ...
