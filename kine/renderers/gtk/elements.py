...
class button(CGI, Element[Gtk.Button]):
    pass


class vbox(CGI, Element[Gtk.Box]):
    pass


class hbox(CGI, Element[Gtk.Box]):
    pass


class entry(CGI, Element[Gtk.Entry]):
    pass


class label(CGI, Element[Gtk.Label]):
    pass
